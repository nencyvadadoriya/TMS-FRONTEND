...
const AssignedToMe: React.FC<AssignedToMeProps> = ({
  currentUser,
  users,
  brands,
  getTaskBorderColor,
  ...
  const tasks = useMemo(() => {
    ...
    return allTasks.filter((t: Task) => {
      ...
      return assignedToEmail === currentUser.email || assignedToUserEmail === currentUser.email;
    });
  ...
  return (
    <div className="space-y-4 p-4 sm:p-5 bg-gray-50 min-h-screen">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-lg font-semibold text-[#0f2a6e]">Assigned To Me</h1>
          <p className="text-[11px] text-gray-500 mt-0.5">Tasks assigned to you by others</p>
        </div>
      ...
      <div className="bg-white rounded-xl border border-[#dbeafe] shadow-sm overflow-hidden">
        <div className="px-4 py-2.5 border-b border-[#dbeafe] bg-gradient-to-r from-[#dbeafe]/30 to-white">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold text-[#0f2a6e]">Tasks Assigned To You</h2>
            {stats.total > 0 && (
        ...
        {stats.total === 0 && (
          <div className="text-center py-8">
            ...
            <p className="text-[9px] text-gray-400 mt-0.5">Tasks assigned to you will appear here</p>
          </div>
        )}
      </div>
    </div>
