...
const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <div className="sticky top-0 z-10 flex-shrink-0 flex h-16 bg-white shadow-sm border-b border-gray-100 w-full ">
      {/* Sidebar Toggle Button */}
      <button
        className="px-4 border-r border-gray-100 text-gray-500 hover:text-primary focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary transition-colors duration-200 lg:hidden"
      ...
      <div className="flex-1 px-4 flex justify-between items-center">
        ...
        <div className="flex-1 flex max-w-md">
          <div className="relative w-full">
            ...
            <input
              className="block w-full pl-9 pr-3 py-2 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent bg-gray-50 text-sm transition-all duration-200"
          ...
          <div className="relative">
            ...
            {showLogout && (
              <>
                ...
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-lg py-2 border border-gray-100 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                  {/* User Info */}
                  ...
                  <button
                    ...
                    className="flex items-center w-full px-4 py-2.5 text-sm text-primary hover:bg-primary-ultralight transition-all duration-200 group"
                  >
